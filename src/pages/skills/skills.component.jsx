...
const Skills = () => {
  return (
    <div className="pt-3 pb-3">
      <h1 className="text-center font-details-b pb-4" style={{color:"black"}}>TECH SKILLS</h1>
      <CardDeck>
        <Row className="d-flex justify-content-around">
          {/* Frontend */}
          <Col md={4}>
            <Card className="focus mt-2 mb-2" style={{backgroundColor:" #fdedec"}}>
              <Card.Body>
                {/* Frontend */}
          ...
          {/* Backend */}
          <Col md={4}>
            <Card className="focus mt-2 mb-2" style={{backgroundColor:"#fcf3cf"}}>
              <Card.Body>
            ...
            {/* Hosting Platforms */}
            <Card className="focus mt-2 mb-2 " style={{backgroundColor:"#eafaf1 "}}> 
          ...
          <Col md={4}>
            ...
            <Card className="focus mt-2 mb-2" style={{backgroundColor:"#edbb99"}}>
              <Card.Body>
