...
const Experience = () => {
  return (
    <div>
      <h1 className="pt-3 text-center font-details-b pb-3" style={{color:"black"}}>EXPERIENCE</h1>
              ...
              <Card.Body className="d-flex justify-content-center flex-column">
                ...
                <div>
                  <div className="text-center style">
                    ...
                    <br />
                    <strong>Technology:</strong> React JS, jQuery, C, MS-SQL,
                    <br />
                    <strong>Duration:</strong> April 2020 - Present
                    <br/>
