...
import Profile from "../../assets/img/profile/mypic.png";
...
const About = () => {
  return (
    <div className="box">
      <div className="about">
        <h1 className="pt-3 text-center font-details pb-3 " style={{color:"white"}}>ABOUT ME</h1>
        <Container>
          <Row className="pt-3 pb-5 align-items-center">
           
            <Col xs={12} md={6}>
              <Row className=" align-items-start p-2 my-details rounded" style={{color:"black"}}>
                Hi there! I am <strong>&nbsp;MD RAKIB HOSSAIN</strong>
