...
import L_voluenter from "../../assets/img/projects/1.PNG";
import L_calculator from "../../assets/img/projects/calculator.PNG";
import L_travel from "../../assets/img/projects/travelguru.PNG";
import L_volen from "../../assets/img/projects/volunter.PNG";
import L_onlineclass from "../../assets/img/projects/online.PNG";
...
{/* Project: Get GitHub Info */}
          ...
          >
            <div className="d-flex justify-content-between flex-column mt-1">
              ...
              <div className="d-flex justify-content-between flex-nowrap text-center">
              <UrlButton
                  href="https://github.com/mdrakibhossainbd/assignment7"
                  target="_blank"
                >
                  SOURCE CODE
                </UrlButton>
                <UrlButton
                  href="https://distracted-hermann-ba3a3d.netlify.app/"
                  target="_blank"
                >
                  SEE LIVE
                </UrlButton>
          ...
          >
            <div className="d-flex justify-content-between flex-column mt-1">
              ...
              <div className="d-flex justify-content-between flex-nowrap text-center">
              <UrlButton href="https://github.com/mdrakibhossainbd/simple-calculator" target="_blank">
                  SOURCE CODE
                </UrlButton>
                <UrlButton href="https://mdrakibhossainbd.github.io/simple-calculator/" target="_blank">
                  SEE LIVE
                </UrlButton>
              </div>
            </div>
